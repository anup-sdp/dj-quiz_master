...
urlpatterns = [
    ...
    path('quiz/category-create/', views.CategoryCreateView.as_view(), name='category-create'), #
	...
	path('quiz/<int:pk>/complete/', views.QuizCompleteView.as_view(), name='quiz-complete'), # ---
